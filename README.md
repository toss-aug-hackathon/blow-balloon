...
- 36종 SVG 풍선을 무작위로 사용하며 연속으로 같은 풍선이 나오지 않습니다.
...
개발 서버가 출력한 주소로 접속합니다. 실제 마이크 입력을 사용하려면 브라우저 또는 Apps in Toss 샌드박스에서 마이크 권한을 허용해야 합니다.
